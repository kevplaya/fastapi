...
4. 회사 태그 정보 추가 : 회사명에 태그 정보를 추가해야 합니다.
5. 회사 태그 정보 삭제 : 회사명에 태그 정보를 삭제해야 합니다.
...
```
DATABASE_URL=mysql+pymysql://root:root@{host_to_yourdb}:3306/wanted
```
